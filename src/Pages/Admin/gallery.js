...
import AdminTablePhoto from "../../Components/Admin_PhotoTable";
import Button from "../../Components/Button/Button";
import { getPhotosData } from "../Photo_Blog/photo-action";
...
function AdminGallery() {
  ...
  const onSubmit = async data => {
    ...
    const response = await fetch(`${process.env.REACT_APP_BASE_URL}/gallery/post/`, {
      method: "POST",
      body: formData,
      headers: {
  ...
  const deletePhotos = async id => {
    const response = await fetch(
      `${process.env.REACT_APP_BASE_URL}/gallery/delete/${id}/`,
      {
        method: "DELETE",
        headers: {
          Authorization: "Bearer " + String(authTokens.access),
